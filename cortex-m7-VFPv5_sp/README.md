# VectorCAST Demo Projects - Cortex-M7F
...
Each directory represents a specific compilers targeting the chip and compiler (GCC, IAR, etc.).

---

---

## 📁 Chip Repository Structure

```
/
├─ Cortex-M7F/
│    ├─ GCC/                         # Demo for GCC ARM Embedded toolchain
│    │  ├─ setenv.bat                # Script to setup directories for code, tools, support files, etc.
│    │  ├─ start_vc.bat              # Script to start VectorCAST for Cortex-M7F & GCC tools
│    │  ├─ GCC_Testing_Project.vcm   # VectorCAST Project for Cortex-M7F & GCC tools
│    │  └─ GCC_Testing_Project       # VectorCAST Project Directory
│    │     └─ environment            # Enironment definitions
│    └─ IAR                          # Demo for IAR ARM Embedded toolchain
│       ├─ setenv.bat                # Script to setup directories for code, tools, support files, etc.
│       ├─ start_vc.bat              # Script to start VectorCAST for Cortex-M7F & IAR tools
│       ├─ IAR_Testing_Project.vcm   # VectorCAST Project for Cortex-M7F & IAR tools
│       └─ IAR_Testing_Project       # VectorCAST Project Directory
│          └─ environment            # Enironment definitions
└─ ...                               # Future targets
```
