...
echo environment build DATABASE.env >> commands.tmp
echo /E:DATABASE tools script run DATABASE.tst >> commands.tmp
echo /E:DATABASE execute all ..\reports\DATABASE_management_report.html >> commands.tmp
echo /E:DATABASE REports Custom CSv_metrics ..\results\DATABASE_coverage.csv >> commands.tmp
