...
echo environment build MANAGER.env >> commands.tmp
echo /E:MANAGER tools script run MANAGER.tst >> commands.tmp
echo /E:MANAGER execute all ..\reports\MANAGER_management_report.html >> commands.tmp
echo /E:MANAGER REports Custom CSv_metrics ..\results\MANAGER_coverage.csv >> commands.tmp
setlocal
