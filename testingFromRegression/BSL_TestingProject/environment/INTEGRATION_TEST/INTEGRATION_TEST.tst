...
-- Test Case: Clear_Table.Steak
TEST.UNIT:manager
TEST.SUBPROGRAM:Clear_Table
TEST.NEW
TEST.NAME:Clear_Table.Steak
TEST.COMPOUND_ONLY
...
-- Test Case: Get_Check_Total.Steak
TEST.UNIT:manager
TEST.SUBPROGRAM:Get_Check_Total
TEST.NEW
TEST.NAME:Get_Check_Total.Steak
TEST.COMPOUND_ONLY
...
TEST.VALUE:manager.Pay_The_Bill.cardNumber:<<malloc 13>>
TEST.VALUE:manager.Pay_The_Bill.cardNumber:"000000000000"
TEST.VALUE:manager.Pay_The_Bill.secCode:<<malloc 4>>
TEST.VALUE:manager.Pay_The_Bill.secCode:"123"
...
-- Test Case: Place_Order.Steak
TEST.UNIT:manager
TEST.SUBPROGRAM:Place_Order
TEST.NEW
TEST.NAME:Place_Order.Steak
TEST.COMPOUND_ONLY
...
TEST.NEW
TEST.NAME:SteakSequence
TEST.SLOT: "1", "manager", "Place_Order", "1", "Place_Order.Steak"
TEST.SLOT: "2", "manager", "Get_Check_Total", "1", "Get_Check_Total.Steak"
TEST.SLOT: "3", "manager", "Pay_The_Bill", "1", "Pay_The_Bill.001"
TEST.SLOT: "4", "manager", "Clear_Table", "1", "Clear_Table.Steak"
TEST.FLOW
  manager.c.Place_Order
  manager.c.Place_Order
  manager.c.Get_Check_Total
  manager.c.Get_Check_Total
  manager.c.Clear_Table
  manager.c.Clear_Table
TEST.END_FLOW
TEST.END
--
